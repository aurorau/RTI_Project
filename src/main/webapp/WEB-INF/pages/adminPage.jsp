...
<html>
	...
	<body>
		...
		<button onclick="resetForm()">Reset</button><br>
	...
	<div id=clickDetails>
		...
		<span>Scroll Count :</span><label id="scrollCount"></label><br>
		...
		<span>Zoom Out Count :</span><label id="zoomOutCount"></label><br>
		<span>Zoom In Count :</span><label id="zoomInCount"></label><br>
